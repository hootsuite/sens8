...
func NewCheckRegistry(sensuClient *sensu.Client) CheckRegistry {
...
func (c *CheckRegistry) Add(checks []checks.Check, resource interface{}, checkSource string) {
...
func (c *CheckRegistry) Update(oldChecks []checks.Check, newChecks []checks.Check, resource interface{}, checkSource string) {
	// check old vs. new
...
func (c *CheckRegistry) Delete(checks []checks.Check, resource interface{}, checkSource string) {
	if _, exists := c.resourceChecks[checkSource]; !exists {
		return
	}
...
func (c *CheckRegistry) startCheck(check checks.Check, updateCh chan interface{}, resource interface{}) {
...
func (c *CheckRegistry) stopCheck(check checks.Check, checkSource string) {
