...
func (c *Client) StartKeepalive(stopCh chan struct{}) {
...
func (c *Client) PostCheckResult(result checks.CheckResult) error {
...
func (c *Client) postKeepAlive() error {
...
func (c *Client) Deregister(client string) error {
